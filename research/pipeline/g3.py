...
def check_drafting_readiness(*, value_gate, execution, analysis, claim_map, evidence, usage_records=(), experiment_records=()):
    ...
    elif execution.research_run_id not in execution_path: missing.append("experiment_artifact_scope")
    ...
    elif execution.research_run_id not in analysis_path: missing.append("analysis_artifact_scope")
